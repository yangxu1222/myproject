...
#include "Ubcf.h"
#include <sstream>
#define TRAINING_SET "/home/yangxu/work/myproject/input/movielens/u1.base"
#define RATE_SP "\t"  //rate Separator
#define USER_NUM 943 //10K:943 1M:6040
#define ITEM_NUM 1682 //10K:1682 1M:3900
#define SIM_FILE "/home/yangxu/work/myproject/output/user_sim"
...
//		string tmp_k;
//		ss >> tmp_k;
    string dst = string("/home/yangxu/work/myproject/output/user_")+string(tmp_k)+string("_max");
